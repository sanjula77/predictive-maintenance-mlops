...
from src.model_registry import list_model_versions, get_version_info
...
def main():
    ...
    if args.format == "json":
        ...
        if all_versions:
            ...
            print(f"🏆 Best MAE:  v{best_mae.get('version')} ({best_mae.get('model_type', '').upper()}) - {best_mae.get('mae', 0):.2f}")
